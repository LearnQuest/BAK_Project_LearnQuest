...
public class trophiesFragment extends Fragment implements View.OnClickListener {
            ...
            for (int i = 0; i < trophie.size(); i++) {
                switch (trophie.get(i)) {
                    ...
                    case 9:
                        ...
                        break;
                    default:
                        Snackbar.make(myFragmentView, getString(R.string.trophWorking), Snackbar.LENGTH_LONG)
    ...
    public void onClick(View view) {
        try {
            ...
            String text;
            switch (dr) {
                case (R.drawable.ic_lock_black_24dp):
                    text = getString(R.string.notroph);
                    break;
                case (R.drawable.trophie1):
                    text = getString(R.string.troph1);
                    break;
                case (R.drawable.trophie2):
                    text = getString(R.string.troph2);
                    break;
                case (R.drawable.trophie3):
                    text = getString(R.string.troph3);
                    break;
                case (R.drawable.trophie4):
                    text = getString(R.string.troph4);
                    break;
                case (R.drawable.trophie5):
                    text = getString(R.string.troph5);
                    break;
                case (R.drawable.trophie6):
                    text = getString(R.string.troph6);
                    break;
                case (R.drawable.trophie7):
                    text = getString(R.string.troph7);
                    break;
                case (R.drawable.trophie8):
                    text = getString(R.string.troph8);
                    break;
                case (R.drawable.trophie9):
                    text = getString(R.string.troph9);
                    break;
                default:
                    text = getString(R.string.trophWorking);
                    break;
            }
